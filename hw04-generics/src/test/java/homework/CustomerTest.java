...
class CustomerTest {
    ...
    @Test
    @DisplayName("setterCustomerTest Проверяем, что класс Customer не сломан")
    ...
    @Test
    @DisplayName("customerAsKeyTest Объект Customer как ключ в карте")
    ...
    @Test
    @DisplayName("scoreSortingTest Сортировка по полю score, итерация по возрастанию")
    ...
    @Test
    @DisplayName("mutationTest Модификация коллекции")
    void mutationTest() {
        //given
        Customer customer1 = new Customer(1, "Ivan", 233);
        Customer customer2 = new Customer(2, "Petr", 11);
    ...
    @Test
    @DisplayName("reverseOrderTest Возвращание в обратном порядке")
